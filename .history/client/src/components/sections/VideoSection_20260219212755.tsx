              ...
              {isPlaying ? (
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 sm:p-12">
                  ...
                  <div className="mb-6 sm:mb-12 relative">
                    ...
                    />
                    <div className="relative z-10 w-20 h-20 sm:w-24 sm:h-24 md:w-32 md:h-32 bg-primary rounded-full flex items-center justify-center shadow-[0_0_50px_rgba(0,255,255,0.4)] group-hover:scale-105 transition-transform">
                      <Play className="h-8 w-8 sm:h-10 sm:w-10 md:h-12 md:w-12 text-white fill-current ml-1" />
                    </div>
                  </div>
