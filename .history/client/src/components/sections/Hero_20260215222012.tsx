...
export function Hero() {
  ...
  <Link href="/projects" className="w-full sm:w-auto">
    <Button
      size="lg"
      className="w-full sm:w-auto rounded-none mt-0  px-8 h-14 md:h-16 text-sm md:text-base font-black tracking-[0.1em] bg-primary text-white hover:bg-black transition-all group relative overflow-hidden shadow-2xl shadow-primary/30"
    >
