...
export function Hero() {
  ...
  SYSTEMS.
              ...
              <p className="text-lg md:text-md text-black/60 mb-8 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-bold tracking-tight">
    ...
    >
      <span className="relative z-10 flex items-center">
       EXPLORE WORK
                ...
                <a href={ar} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto rounded-none px-8 h-14 md:h-16 text-sm md:text-base font-black tracking-[0.1em] border-black text-black hover:bg-black hover:text-white transition-all backdrop-blur-sm">
                    RESUME.PDF
                ...
                >
                  <div className="relative">
                    ...
                    />
                        <Target className="h-4 w-4 text-black relative z-10" />
                
                  </div>
                    <span className="text-sm font-black text-black uppercase tracking-[0.09em] group-hover:text-primary transition-colors">
   START MISSION
    </span>
  </button>
