      ...
      <span className="relative z-10 flex items-center">
       EXPLORE WORK
                ...
                <a href={RESUME_LINK} target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto">
                  <Button variant="outline" size="lg" className="w-full sm:w-auto rounded-none px-8 h-14 md:h-16 text-base md:text-lg font-black tracking-[0.1em] border-black text-black hover:bg-black hover:text-white transition-all backdrop-blur-sm">
                    RESUME.PDF
