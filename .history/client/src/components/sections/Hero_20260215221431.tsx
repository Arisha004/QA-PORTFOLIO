...
const RESUME_LINK = "https://your-resume-link.com"; // 👈 Replace with your resume link
...
<div className="flex flex-col sm:flex-row flex-wrap gap-5 md:gap-8 justify-center lg:justify-start items-center">
  ...
  <Link href="/projects" className="w-full sm:w-auto">
    <Button
      size="lg"
      className="w-full sm:w-auto rounded-none px-8 h-14 md:h-16 text-sm md:text-base font-black tracking-[0.1em] bg-primary text-white hover:bg-black transition-all group relative overflow-hidden shadow-2xl shadow-primary/30"
    >
  ...
  >
    <Button
      variant="outline"
      size="lg"
      className="w-full sm:w-auto rounded-none px-8 h-14 md:h-16 text-sm md:text-base font-black tracking-[0.1em] border-black text-black hover:bg-black hover:text-white transition-all backdrop-blur-sm"
    >
      RESUME.PDF
  ...
  <button
    ...
    className="w-full sm:w-auto flex items-center justify-center gap-4 px-8 h-14 md:h-16 border border-black/20 group cursor-pointer hover:bg-black/10 transition-all duration-300 backdrop-blur-md rounded-lg shadow-xl"
  >
    <div className="relative">
      ...
      />
      <Target className="h-5 w-5 text-black relative z-10" />
    </div>
    <span className="text-xs font-black text-black uppercase tracking-[0.3em] group-hover:text-primary transition-colors">
      START MISSION
    </span>
  </button>
