        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-xl md:text-7xl lg:text-[8rem] xl:text-[9rem] font-display font-black leading-[0.8] tracking-tighter mb-10 uppercase text-black">
