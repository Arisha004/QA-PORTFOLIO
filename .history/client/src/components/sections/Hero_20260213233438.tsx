        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-24 items-center">
          <div className="lg:col-span-7 text-center lg:text-left">
            ...
            >
              ...
              <h1 className="text-3xl sm:text-6xl md:text-7xl lg:text-[8rem] xl:text-[9rem] font-display font-black leading-[0.8] tracking-tighter mb-10 uppercase text-black">
              ...
              <div className="flex flex-col sm:flex-row flex-wrap gap-5 md:gap-8 justify-center lg:justify-start items-center">
                <Link href="/projects" className="w-full sm:w-auto">
                  <Button size="lg" className="w-full sm:w-auto rounded-none px-12 h-16 md:h-20 text-base md:text-lg font-black tracking-[0.1em] bg-primary text-white hover:bg-black transition-all group relative overflow-hidden shadow-2xl shadow-primary/30">
