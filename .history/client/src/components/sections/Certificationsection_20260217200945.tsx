...
const CERTIFICATE_LINK = "https://your-certificate-link.com"; // 👈 paste your link here
            ...
            >
              ...
              <div className="relative bg-white border border-black/10 p-8 md:p-12 rounded-[3rem] shadow-2xl overflow-hidden aspect-[3/4] flex flex-col justify-between group-hover:border-primary/30 transition-all duration-500">
                ...
                <div className="relative z-10 text-left">
                  ...
                  <div className="flex items-center justify-between gap-4 p-6 bg-black/5 rounded-2xl border border-dashed border-black/10 group-hover:bg-white group-hover:border-primary/30 group-hover:shadow-lg transition-all duration-500">
