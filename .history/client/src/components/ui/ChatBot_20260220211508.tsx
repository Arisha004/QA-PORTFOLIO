...
const CONTACT_EMAIL = "arisha.qa@example.com";
const LINKEDIN_URL = "https://linkedin.com/in/arisha-qa";
...
export function ChatBot() {
  ...
  const generateResponse = (userInput: string): string => {
    ...
    switch (intent) {
      ...
      default:
        if (lastIntent) {
          return "Would you like me to expand further on that area?";
        }
        return "I can provide details about her education, technical skills, automation expertise, projects, hiring availability, or contact information. What would you like to explore?";
    }
  };
