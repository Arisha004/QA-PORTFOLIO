...
>
  {!isOpen && (
    ...
    >
      {/* Glow */}
      <div className="absolute inset-0 rounded-full bg-primary/25 blur-lg group-hover:blur-xl transition-all duration-300" />
      ...
      {/* CTA Text */}
      <div className="absolute -top-10 right-0 bg-white dark:bg-black border border-border px-2 py-0.5 rounded-full text-[10px] shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300">
