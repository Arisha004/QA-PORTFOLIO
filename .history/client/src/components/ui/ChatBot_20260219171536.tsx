      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
           ...
           className="fixed bottom-20 right-4 md:bottom-24 md:right-6 w-[calc(100vw-32px)] sm:w-[320px] md:w-[360px] h-[420px] md:h-[460px] glass-card z-[100] flex flex-col overflow-hidden rounded-2xl border border-white/20 shadow-xl bg-white/95 dark:bg-black/95 backdrop-blur-2xl"
