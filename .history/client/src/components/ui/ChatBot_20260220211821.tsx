...
default:
  ...
  return "Arisha is a disciplined and systems-oriented aspiring QA Engineer focused on building resilient, scalable testing infrastructures. Her work emphasizes structured documentation, automation architecture, and long-term software reliability. If you’d like, I can elaborate on any specific area of her journey.";
);
    }
  const handleSend = () => {
