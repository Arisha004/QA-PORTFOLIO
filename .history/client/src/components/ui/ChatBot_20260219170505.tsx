...
>
  {!isOpen && (
    ...
    >
      {/* Glow Effect */}
      <div className="absolute inset-0 rounded-full bg-primary/30 blur-xl group-hover:blur-2xl transition-all duration-300" />

      {/* Robot Image */}
      <img
        src="/assets/robot-3d.png"
        alt="Chat with Arisha"
        className="relative w-16 sm:w-20 drop-shadow-2xl transition-transform duration-300 group-hover:scale-110"
      />

      {/* CTA Text Bubble */}
      <div className="absolute -top-12 right-0 bg-white dark:bg-black border border-border px-3 py-1 rounded-full text-xs shadow-md whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300">
        Click to know more about Arisha 🚀
      </div>
    </motion.div>
  )}
</motion.div>
