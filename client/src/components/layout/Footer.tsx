...
export function Footer() {
  ...
  return (
    <footer className="bg-[#05070a] text-white py-24 md:py-40 relative overflow-hidden border-t border-white/10">
      {/* Background Decor */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-32 items-start">
          <div className="lg:col-span-5 text-center lg:text-left">
            <div className="flex items-center justify-center lg:justify-start gap-4 mb-10">
              <div className="p-3 bg-primary/20 border border-primary/30 rounded-2xl">
            ...
            <p className="text-white/60 text-sm md:text-base font-medium mb-12 max-w-sm mx-auto lg:mx-0 leading-relaxed uppercase tracking-[0.2em]">
            ...
            <div className="hidden lg:block">
              <div className="inline-flex items-center gap-4 p-6 bg-white/5 border border-white/10 rounded-3xl backdrop-blur-sm">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/80 whitespace-nowrap">Global QA Infrastructure Verified</span>
              </div>
            </div>
          </div>
          
          <div className="lg:col-span-7 w-full">
            <div className="bg-white/5 border border-white/20 p-8 md:p-14 rounded-[3rem] backdrop-blur-xl relative overflow-hidden group">
              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <Input name="name" required className="rounded-2xl bg-white/10 border-white/30 h-16 text-white placeholder:text-white/40 focus:ring-primary focus:border-primary px-6 text-base" placeholder="Full Name" />
                  </div>
                  <div className="space-y-3">
                    <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/90 ml-1">Encrypted Mail</label>
                    <Input name="email" required type="email" className="rounded-2xl bg-white/10 border-white/30 h-16 text-white placeholder:text-white/40 focus:ring-primary focus:border-primary px-6 text-base" placeholder="email@address.com" />
                  </div>
                </div>
                
                <div className="space-y-3">
                  <label className="text-[10px] font-black uppercase tracking-[0.3em] text-white/90 ml-1">Message Payload</label>
                  <Textarea name="message" required className="rounded-[2rem] bg-white/10 border-white/30 min-h-[180px] text-white placeholder:text-white/40 focus:ring-primary focus:border-primary px-6 py-6 text-base" placeholder="Describe your quality requirements..." />
                </div>
                
                <Button disabled={isSubmitting} className="w-full h-20 rounded-[2rem] bg-primary text-black font-black text-lg uppercase tracking-[0.3em] hover:bg-white hover:text-black transition-all duration-500 shadow-2xl shadow-primary/20 group">
        ...
        <div className="mt-24 md:mt-40 pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-10 md:gap-8">
          ...
          <div className="flex flex-wrap justify-center gap-10 md:gap-16">
            ...
            <Link href="/system" className="text-[10px] font-black uppercase tracking-[0.4em] text-white hover:text-primary transition-colors flex items-center gap-3 group">
              <Cpu className="h-4 w-4 opacity-60 group-hover:opacity-100" />
              System
            </Link>
          </div>
        </div>
