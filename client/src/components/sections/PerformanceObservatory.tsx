      ...
      <div className="container-custom">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-5">
            ...
            <div className="space-y-4">
               {["Performance Audit", "Accessibility Check", "SEO Best Practices"].map(item => (
                 <div key={item} className="flex items-center gap-4 p-4 border border-border bg-background">
          ...
          <div className="lg:col-span-7 relative">
             ...
             <Card className="p-10 glass-card min-h-[450px] flex flex-col justify-center items-center rounded-none border-border">
                <div className="w-full h-[350px]">
                  <ResponsiveContainer width="100%" height="100%">
                    <RadialBarChart cx="50%" cy="50%" innerRadius="20%" outerRadius="90%" barSize={20} data={data}>
                      ...
                      <Tooltip 
                        contentStyle={{ backgroundColor: 'white', border: '1px solid #eee', borderRadius: '0px' }}
                      />
                    </RadialBarChart>
                  </ResponsiveContainer>
                </div>
                <div className="text-[10px] font-black uppercase tracking-widest opacity-40 mt-8">Practice Project Quality Metrics</div>
             </Card>
          </div>
        </div>
      </div>
